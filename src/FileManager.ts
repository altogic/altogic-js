...
export class FileManager extends APIBase {
   ...
   async delete(): Promise<{ errors: APIError | null }> {
      const { errors } = await this.fetcher.post(`/_api/rest/v1/storage/bucket/file/delete`, {
         file: this.#fileNameOrId,
         bucket: this.#bucketNameOrId,
      });
   ...
   async addTags(
      ...
      return await this.fetcher.post(`/_api/rest/v1/storage/bucket/file/add-tags`, {
         tags,
         file: this.#fileNameOrId,
         bucket: this.#bucketNameOrId,
      });
   ...
   async removeTags(
      ...
      return await this.fetcher.post(`/_api/rest/v1/storage/bucket/file/remove-tags`, {
         tags,
         file: this.#fileNameOrId,
         bucket: this.#bucketNameOrId,
      });
   ...
   async updateInfo(
      ...
      return await this.fetcher.post(`/_api/rest/v1/storage/bucket/file/update`, {
         newName,
         isPublic,
         tags,
         file: this.#fileNameOrId,
