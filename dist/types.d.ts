...
export interface FileSortEntry {
     ...
     * @type {string}
     */
    field: "bucketId" | "fileName" | "size" | "encoding" | "mimeType" | "isPublic" | "publicPath" | "uploadedAt" | "updatedAt" | "userId" | "tags";
    /**
     * Sort direction
     * @type {string}
     */
 ...
 */
export declare type ListenerFunction = (payload: EventData) => void;
/**
 ...
 * @type ListenerFunction
 */
export declare type UserEventListenerFunction = (eventName: string, session: Session | null) => void;
